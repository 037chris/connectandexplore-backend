...
const category2:categoryResource = {
  ...
  description: "Ein großes Festival mit verschiedenen Musikgenres und lokalen Künstlern.",
  price: 50,
...
const event2: eventResource = {
  ...
  description: "Eine kulinarische Reise durch die Street Food Kulturen der Welt.",
  price: 10,
