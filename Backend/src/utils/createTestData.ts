...
const createTestData = async () => {
  ...
  const u: userResource = {
    ...
    profilePicture: "/b6e07b53-ceda-47a9-bcb7-982dab8d42a2-pexels-andrew-personal-training-697509.jpg",
    gender: "male",
    isActive: true,
  };
  ...
  const u2: userResource = {
    ...
    profilePicture: "/5755979f-77b5-434a-a138-ba8a04123a7c-gabriel-silverio-u3WmDyKGsrY-unsplash.jpg",
    gender: "female",
    isActive: true,
  };
  ...
  const u3: userResource = {
    ...
    profilePicture: "/603730c2-9900-4933-88db-31ab0b716c20-pexels-spencer-selover-428364.jpg",
    gender: "male",
    isActive: true,
  };
  ...
  const u4: userResource = {
    ...
    profilePicture: "/6575e27b-4a7c-4c25-96fb-8d21fd4b0131-pexels-ike-louie-natividad-2709388.jpg",
    gender: "female",
    isActive: true,
  };
    ...
    const u5: userResource = {
      ...
      profilePicture: "/9ce763e8-b534-43b5-b966-32ff0656da52-pexels-jack-winbow-1559486.jpg",
      gender: "male",
      isActive: true,
    };
    ...
    const u6: userResource = {
      ...
      profilePicture:  "/6214908e-0324-4d71-8fa2-5dd584869f7a-pexels-andrea-piacquadio-733872.jpg",
      gender: "female",
      isActive: true,
    };

      // User 7
  const u7: userResource = {
    email: "Sam@some-host.de",
    name: {
      first: "Sam",
      last: "Miller",
    },
    ...
    isAdministrator: false,
    address: a,
    birthDate: new Date("1996-12-07"),
    profilePicture: "/d94dca59-dc26-4a7d-94c4-a4a54ea6beba-pexels-andrew-personal-training-697509.jpg",
    gender: "male",
    isActive: true,
  };
  ...
  const u8: userResource = {
    ...
    profilePicture: "/2411f4e4-f8ce-47af-a9cc-25a8526d4392-michael-dam-mEZ3PoFGs_k-unsplash.jpg",
    gender: "female",
    isActive: true,
  };
  ...
  const u9: userResource = {
    ...
    profilePicture: "/17571a15-2bb1-40c0-9722-6e2e38174e0d-pexels-italo-melo-2379004.jpg",
    gender: "male",
    isActive: true,
  };
  ...
  const categories = [
    { name: "Kultur & Kunst", description: "Events im Bereich Kultur und Kunst" },
    ...
    { name: "Hobbys", description: "Events rund um Hobbys und Freizeitaktivitäten" },
  ...
  const event9: eventResource = {
   ...
   const event10: eventResource = {
    ...
    const event11: eventResource = {
      ...
      description: "Workshop für angehende Fotografen zum Erlernen neuer Techniken.",
      price: 15,
  ...
  const event16: eventResource = {
    ...
    description: "Entdecken Sie die faszinierende Stadt Berlin bei einer aufregenden Erkundungstour. Besichtigen Sie historische Sehenswürdigkeiten, erleben Sie die lebendige Kultur und probieren Sie lokale Köstlichkeiten.",
    price: 15,
...
const event17: eventResource = {
  ...
  description: "Erkunden Sie die Schönheit der Natur bei einer aufregenden Wandertour. Unsere Wanderexperten führen Sie durch malerische Landschaften und sorgen für ein unvergessliches Naturerlebnis.",
  price: 10,
...
const event18: eventResource = {
  name: "Cooking Class",
  description: "Nehmen Sie an unserer exklusiven Kochklasse teil und lernen Sie von einem erstklassigen Profikoch. Entdecken Sie die Geheimnisse der kulinarischen Welt und zaubern Sie köstliche Gerichte in Ihrer eigenen Küche.",
  price: 30,
...
const event20: eventResource = {
  ...
  description: "Connect & Explore ist ein innovatives Projekt, das darauf ausgerichtet ist, in einer zunehmend digital vernetzten Welt Menschen miteinander zu verbinden und ihnen die Möglichkeit zu geben, faszinierende Veranstaltungen und Erlebnisse in ihrer Stadt zu entdecken.",
  price: 10,
  ...
  participants: [alice.id, tom.id, emily.id, john.id, jane.id, bob.id, charlie.id, emily.id, olivia.id],
};
