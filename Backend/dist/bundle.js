...
/***/505:
/***/function(e,t,r){var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.server=void 0;const n=a(r(860)),i=r(986),s=r(231),o=r(582),d=s.readFileSync("./certificates/key.pem"),c=s.readFileSync("./certificates/cert.pem"),u=r(14),l=a(r(993)),m=a(r(617)),p=(r(685),a(r(811))),h=a(r(79)),g=a(r(562)),y=a(r(11)),f=a(r(996)),w=a(r(653)),v=a(r(109)),b=a(r(952)),E=(0,n.default)(),S=process.env.PORT||443;
/* Routes */
...
e.to(a).emit("receive_message",{user:t,message:r,time:n})}))})),E.use(i.json()),E.use(n.default.urlencoded({extended:!0})),E.use(n.default.static(__dirname)),E.use("/api/users",h.default),E.use("/api",g.default),E.use("/api/login",y.default),E.use("/api/events",f.default),E.use("/api/comments",v.default),E.use("/api/chat",b.default),E.use("/images/users",n.default.static("uploads/users")),E.use("/images/events",n.default.static("uploads/events")),(0,p.default)(E,+S),E.use(((e,t,r)=>{t.status(404).json("Not Found")})),(0,u.connect)().then((async()=>{
...
if(s.id=n,"a"===e.role)try{const e=await u.updateUserWithAdmin(s);t.status(200).send(e)}catch(e){t.status(404),r(e)}else if(e.userId!==n)t.status(403),r(new Error("Invalid authorization, can not update user."));else try{let r;e.body.oldPassword&&(r=e.body.oldPassword),console.log("oldPw:",r);const a=await u.updateUserWithPw(s,r);t.status(200).send(a)}catch(e){t.status(403),r(new Error("Invalid authorization, probably invalid password."))}})),
/**
 * @swagger
 * /api/users/{userid}:
 *   delete:
