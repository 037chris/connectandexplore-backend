...
/***/505:
/***/function(e,t,r){var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.server=void 0;const i=a(r(860)),n=r(986),s=r(231),o=r(582),d=s.readFileSync("./certificates/key.pem"),c=s.readFileSync("./certificates/cert.pem"),u=r(14),l=a(r(993)),p=a(r(617)),m=r(685),h=a(r(811)),g=a(r(79)),f=a(r(562)),y=a(r(11)),w=a(r(996)),v=a(r(653)),b=a(r(109)),E=a(r(952)),S=a(r(62)),I=(0,i.default)(),j=process.env.PORT||5e3;
/* Routes */
I.use("*",o()),I.use((function(e,t,r){t.header("Access-Control-Allow-Origin","*"),t.header("Access-Control-Allow-Headers","Origin, X-Requested-With, Content-Type, Accept"),t.header("Access-Control-Expose-Headers","Authorization"),r()})),t.server="443"===j?m.createServer(I):p.default.createServer({key:d,cert:c},I);r(69)(t.server,{cors:{
//origin: "http://localhost:3000",
methods:["GET","POST"]}}).on("connection",(e=>{
...
e.to(a).emit("receive_message",{user:t,message:r,time:i})}))})),I.use(n.json()),I.use(i.default.urlencoded({extended:!0})),I.use(i.default.static(__dirname)),I.use("/api/users",g.default),I.use("/api",f.default),I.use("/api/login",y.default),I.use("/api/events",w.default),I.use("/api/comments",b.default),I.use("/api/chat",E.default),I.use("/images/users",i.default.static("uploads/users")),I.use("/images/events",i.default.static("uploads/events")),I.use("/api/rating",S.default),(0,h.default)(I,+j),I.use(((e,t,r)=>{t.status(404).json("Not Found")})),(0,u.connect)().then((async()=>{
// Create admin user after connecting to the database
await(0,l.default)(),await(0,v.default)(),t.server.listen(j,(()=>{console.log("Listening on port ",j)}))})).catch((e=>{console.error("Failed to connect to the database:",e)})),t.default=I},
/***/439:
...
t.Event=(0,a.model)("Event",s),t.Categoty=(0,a.model)("Category",i),t.Chat=(0,a.model)("Chat",n)}
/***/,
/***/467:
 ...
 */
u.get("/event/:id/average-rating",(0,s.param)("id").isMongoId(),(async(e,t,r)=>{try{const r=e.params.id,a=await l.getAverageRatingForEvent(r);t.status(200).json(a)}catch(e){t.status(500).json({error:"Internal Server Error"})}})),t.default=u},
/***/996:
...
// Delete the file
console.log("errors:",a),(0,d.deleteEventThumbnail)(e.file.path)),t.status(400).json({errors:a.array()});try{const r=await u.getEvent(e.params.eventid);e.file&&(e.body.thumbnail=`/${e.file.filename}`,r.thumbnail&&(0,d.deleteEventThumbnail)(r.thumbnail),console.log("Event bild uploaded")),e.body.category&&(e.body.category=JSON.parse(e.body.category)),e.body.hashtags&&(e.body.hashtags=JSON.parse(e.body.hashtags)),e.body.price&&(e.body.price=Number(e.body.price)),e.body.address&&(e.body.address=JSON.parse(e.body.address)),console.log("Event data ",e.body);const a=e.body,i=await u.updateEvent(e.params.eventid,a,e.userId);t.status(200).send(i)}catch(a){(0,d.deleteEventThumbnail)(e.body.thumbnail),t.status(404),r(a)}})),
/**
 * @swagger
 * /api/events/{eventid}:
 *   delete:
...
// for deployment
t="443"===d?"/app":"../../Backend";const r=n.default.join(__dirname,t,"uploads/users",e);// Assuming 'FileUpload.ts' is in the 'utils' directory
console.log("fullPath:",r),s.default.unlinkSync(r),console.log("file deleted",r)}catch(e){throw e}},t.deleteEventThumbnail=function(e){try{let t;
// for deployment
t="443"===d?"/app":"../../Backend";const r=n.default.join(__dirname,t,"uploads/events",e);// Assuming 'FileUpload.ts' is in the 'utils' directory
console.log("fullpath image Event:",r),s.default.unlinkSync(r)}catch(e){throw e}},
