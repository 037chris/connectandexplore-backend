...
/* Routes */
w.use("*",o()),w.use((function(e,t,r){t.header("Access-Control-Allow-Origin","*"),t.header("Access-Control-Allow-Headers","Origin, X-Requested-With, Content-Type, Accept"),t.header("Access-Control-Expose-Headers","Authorization"),r()})),w.use(a.json()),w.use(s.default.urlencoded({extended:!0})),w.use(s.default.static(__dirname)),w.use("/api/users",h.default),w.use("/api",y.default),w.use("/api/login",g.default),w.use("/api/events",f.default),(0,m.default)(w,+v),w.use(((e,t,r)=>{t.status(404).json("Not Found")})),(0,u.connect)().then((async()=>{
// Create admin user after connecting to the database
await(0,l.default)(),p.default.createServer({key:d,cert:c},w).listen(v,(()=>{console.log("Listening on port 443")}))})).catch((e=>{console.error("Failed to connect to the database:",e)})),t.default=w},
/***/924:
...
/***/,
/***/0:
/***/function(e,t,r){var i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.upload=t.deleteEventThumbnail=t.deleteProfilePicture=void 0;const s=i(r(738)),a=i(r(17)),n=i(r(231)),o=r(828),d=s.default.diskStorage({destination:function(e,t,r){r(null,a.default.join(__dirname,"/uploads/"))},filename:function(e,t,r){r(null,`${(0,o.v4)()}-${t.originalname}`)}});t.deleteProfilePicture=function(e){try{const t=a.default.join(__dirname,e);n.default.unlinkSync(t)}catch(e){throw e}},t.deleteEventThumbnail=function(e){
/* try {
...
t.upload=(0,s.default)({storage:d,fileFilter:(e,t,r)=>{"image/jpg"===t.mimetype||"image/jpeg"===t.mimetype||"image/png"===t.mimetype?r(null,!0):r(new Error("Image uploaded is not of type jpg/jpeg or png"),!1)},limits:{fileSize:10485760}})},
/***/448:
