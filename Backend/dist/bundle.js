...
/***/505:
/***/function(e,t,r){var i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0});const s=i(r(860)),a=r(986),n=r(231),o=r(582),d=n.readFileSync("./certificates/key.pem"),c=n.readFileSync("./certificates/cert.pem"),u=r(14),l=i(r(993)),p=i(r(617)),m=(r(685),i(r(811))),h=i(r(79)),y=i(r(562)),f=i(r(11)),g=i(r(996)),w=i(r(653)),v=(0,s.default)(),b=process.env.PORT||443;
/* Routes */
v.use("*",o()),v.use((function(e,t,r){t.header("Access-Control-Allow-Origin","*"),t.header("Access-Control-Allow-Headers","Origin, X-Requested-With, Content-Type, Accept"),t.header("Access-Control-Expose-Headers","Authorization"),r()})),v.use(a.json()),v.use(s.default.urlencoded({extended:!0})),v.use(s.default.static(__dirname)),
...
await(0,l.default)(),await(0,w.default)(),p.default.createServer({key:d,cert:c},v).listen(b,(()=>{console.log("Listening on port 443")}))})).catch((e=>{console.error("Failed to connect to the database:",e)})),t.default=v},
/***/924:
