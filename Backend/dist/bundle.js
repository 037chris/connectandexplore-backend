...
/***/505:
/***/function(e,t,r){var i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0});const s=i(r(860)),a=r(986),n=r(231),o=r(582),d=n.readFileSync("./certificates/key.pem"),c=n.readFileSync("./certificates/cert.pem"),u=r(14),l=i(r(993)),p=i(r(617)),m=(r(685),i(r(811))),h=i(r(79)),y=i(r(562)),f=i(r(11)),g=i(r(996)),w=(0,s.default)(),v=process.env.PORT||443;
/* Routes */
w.use("*",o()),w.use((function(e,t,r){t.header("Access-Control-Allow-Origin","*"),t.header("Access-Control-Allow-Headers","Origin, X-Requested-With, Content-Type, Accept"),t.header("Access-Control-Expose-Headers","Authorization"),r()})),w.use(a.json()),w.use(s.default.urlencoded({extended:!0})),w.use(s.default.static(__dirname)),w.use("/api/users",h.default),w.use("/api",y.default),w.use("/api/login",f.default),w.use("/api/events",g.default),(0,m.default)(w,+v),w.use(((e,t,r)=>{t.status(404).json("Not Found")})),(0,u.connect)().then((async()=>{
